...
#search{height:100px; width:500px; margin-top:20px;}
#data{height:300px; margin-right:20px; margin-left:20px;}
.title{font-size:14pt; font-weight:bold; color:#000; margin-bottom:30px; text-transform:uppercase;}
body{background-image: url(../../mycss/images/bg.jpg);}
</style>
