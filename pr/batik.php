...
$tampil=mysqli_query($koneksidb,"select * from produk where produk.kd_kategori=2");
...
<div class='prod_details_tab'> <a href='index2.php?data=ranjang' class='prod_buy'>Beli</a> 
<a href='index2.php?data=det&id=$z[id]' class='prod_details'>Details</a> </div>
      </div>
